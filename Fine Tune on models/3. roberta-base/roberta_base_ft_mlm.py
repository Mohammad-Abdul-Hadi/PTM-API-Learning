...
if __name__ == '__main__':
    ...
    tokenizer = RobertaTokenizerFast.from_pretrained(roberta_base,  max_len=MAX_LEN)
    ...
    roberta_shared = EncoderDecoderModel.from_encoder_decoder_pretrained(roberta_base, roberta_base, tie_encoder_decoder=True)
